  ...
  return (
    <section className="relative overflow-hidden py-28 text-white">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, rgba(22,46,81,0.92) 0%, rgba(22,46,81,0.7) 55%, rgba(0,94,162,0.4) 100%)',
        }}
      />
      <div className="container-page relative max-w-3xl">
        <p className="text-xs font-semibold tracking-[0.16em] text-[var(--gp-yellow)] uppercase">
