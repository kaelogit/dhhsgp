...
import { applicantContactWithin, RESPONSE_HOURS } from '@/lib/site';
...
const steps = [
  ...
  {
    title: 'Background',
    body: 'Department of Health and Human Services issues billions of dollars in grant money each year to a variety of groups. Grants are awarded to individuals each and every day. Your file is still reviewed on its own merits.',
  },
  {
    title: 'Submit',
  ...
  {
    title: 'Monitoring',
    body: 'DHHS keeps an official email thread on each file. Reply on that thread. Do not send passwords. If a new person contacts you, verify on this website first.',
  },
  {
    title: 'Contact',
    body: 'Official follow-up is by email only. If you are unsure whether a message is real, use the Verify page first.',
  },
];
    ...
    <div className="bg-white">
      ...
      <section className="border-b border-[var(--gp-line)] bg-[var(--gp-navy)] pt-16 pb-14 text-white">
        <div className="container-page max-w-3xl">
          ...
          <h1 className="mt-3 text-4xl text-white">How a DHHS grant works</h1>
