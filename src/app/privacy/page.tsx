  ...
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <LegalSection title="Email">
        Application receipts come from {APPLY_FROM_NAME} ({APPLY_FROM_EMAIL}). After you apply, a
        coordinator contacts you by email. Check inbox and spam. We will never ask for your email or
        banking passwords.
      </LegalSection>
