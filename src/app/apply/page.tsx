    ...
    <div className="bg-white">
      <section className="border-b border-[var(--gp-line)] bg-[var(--gp-navy)] pt-16 pb-12 text-white">
        <div className="container-page max-w-3xl">
          ...
          <h1 className="mt-3 text-4xl text-white">Your DHHS grant application</h1>
          <p className="mt-4 text-sm leading-relaxed text-white/80 md:text-base">
            Department of Health and Human Services issues billions of dollars in DHHS grant money each year.
            Awards go to individuals every day. DHHS programs are not loans. {HELP_AREAS_SHORT}
          </p>
            ...
            {status === 'success' ? (
              <div className="border border-[var(--gp-line)] bg-[var(--gp-paper)] p-8">
                ...
                <p className="mt-4 text-sm leading-relaxed text-[var(--gp-muted)]">
                  Your application has been received. A DHHS grant coordinator will be assigned to
                ...
                <p className="mt-3 text-sm leading-relaxed text-[var(--gp-muted)]">
                  ...
                  an email from your assigned coordinator at {CONTACT_EMAIL} within{' '}
                ...
                <p className="mt-4 text-sm font-medium text-[var(--gp-navy)]">
                  You did the hard part by asking. Rest tonight. We will take the next step. DHHS
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <label className="flex items-start gap-2 text-sm text-[var(--gp-muted)]">
                  <input
                    ...
                    className="mt-1"
                  />
                  I understand DHHS grants are not loans, and applying does not guarantee an award.
                </label>
          ...
          <aside className="space-y-5">
            ...
            <div className="space-y-3 border border-[var(--gp-line)] p-5 text-sm text-[var(--gp-muted)]">
              ...
              <p className="flex gap-2">
                ...
                Coordinator assigned to your file
              </p>
              <p className="flex gap-2">
