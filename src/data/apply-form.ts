...
export const APPLY_FAQS = [
  {
    q: 'Is a DHHS grant a loan?',
    a: 'No. DHHS programs are not loans. If you are selected, you do not repay the award. Applying does not create debt.',
  },
  {
    q: 'How soon will I hear back?',
    a: `${APPLY_FROM_NAME} sends a receipt from ${APPLY_FROM_EMAIL}. A coordinator assigned to your file then contacts you from ${COORDINATOR_EMAIL} within ${RESPONSE_HOURS} hours. Check inbox and spam, then reply on that thread.`,
  },
  {
