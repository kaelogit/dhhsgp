...
export const recipientStories: RecipientStory[] = [
  ...
  },
  {
    ...
    story: [
      ...
      'DHHS treated the application like a real file, not a slogan. I wrote what the money would buy: a used van, insurance, and inventory to start. No one asked me to borrow against my house.',
      'The $640,000 grant let me open Hale Field Supply. I still work long days. The difference is the name on the door is mine, and the people I hired are on a payroll I can actually meet. DHHS did not make me a salesman. I already was one. They gave me the start so I could work for myself.',
    ],
  },
  {
    name: 'Marisol V.',
    ...
    story: [
      ...
      'I applied under buying a home and told the truth: we were not asking DHHS to buy us a mansion. We needed the last piece so the contract would hold.',
      'The $950,000 grant covered what the lender would not. We closed in April. The first night I sat on the floor of an empty living room and laughed until I cried. The house is modest. It is ours. Buying a home should not require a miracle. For us, a DHHS grant was the last honest piece.',
    ],
  },
  {
    name: 'Keisha Grant',
    ...
    story: [
      ...
      'DHHS’s teacher grant did not feel like charity. It felt like someone understood that educators are people with rent, too. I listed the bills and the classroom list separately so they could see both.',
  ...
  },
  {
    ...
    story: [
      ...
      'A former student told me DHHS awards grants to retired teachers. I applied because I was out of pride and out of time. Sarah’s email was plain. I liked that.',
  ...
  },
  {
    ...
    story: [
      ...
      'Going to school is one of the reasons DHHS says people should apply. I wrote that sentence on a notepad before I submitted, just to remind myself it was allowed.',
  ...
  },
  {
    ...
    story: [
      ...
      'DHHS asked for the statements, not a performance. I sent them. I waited. I did not sleep much that week.',
  ...
  },
  {
    ...
    story: [
      ...
      'The Department of Health and Human Services application took an evening. I said I was looking for financial assistance and I meant it. No drama. Just numbers.',
  ...
  },
  {
    ...
    story: [
      ...
      'DHHS said paying medical bills is one of the reasons people apply. I wrote that on the form so I would not talk myself out of it. Sarah asked for the statements. I sent every page.',
      'The $520,000 grant closed the hospital file. I still have physical therapy. I do not have a collector saved as “Unknown.” If you are sitting with medical bills, you are not the first person DHHS has heard from today.',
    ],
  },
  {
    name: 'Nadia Cole',
  ...
  },
  {
    ...
    story: [
      ...
      'Buying a home is one of the reasons DHHS says people should apply. I wrote the numbers without a speech. Sarah asked two questions. I answered them the same night.',
  ...
  },
  {
    ...
    story: [
      ...
      'Department of Health and Human Services said completeness matters more than a perfect label. I was complete. I was not elegant. Sarah treated the letter like a file, not a complaint.',
  ...
  },
  {
    ...
    story: [
      ...
      'I applied because Department of Health and Human Services said older retired people looking for financial assistance are welcome. I did not write a speech. I wrote the deductible, the copays, and the fact that my daughter lives four states away and I will not move in with her.',
  ...
  },
  {
    ...
    category: 'Retired teachers',
    amount: '$165,000',
    quote: 'I taught three generations in one town. The town did not owe me a roof. DHHS helped anyway.',
    story: [
  ...
  },
  {
    ...
    story: [
      ...
      'This was not a foreclosure story. It was a renovation with a purpose. I applied under housing, listed the contractor bid, the timeline, and why a grant fit our goal better than debt. Sarah replied within twenty-four hours. No one asked why we had not sold investments first. They asked whether the bid included the accessibility specs.',
      'The $650,000 grant funded the addition. My father slept in the new room last Thanksgiving. My mother made coffee in a kitchen that does not require stairs. No bank called me on the first of the month. If your need is improvement and not survival, you still belong in the queue.',
    ],
  },
  {
    name: 'Dr. Amara Osei',
...
export { allAwards as recentAwards } from '@/data/awards';
