...
export const faqItems = [
  {
    question: 'Is a DHHS grant a loan?',
    answer:
      'No. DHHS grant programs are not loans. If you are selected, you do not repay the award. Applying does not create debt and does not guarantee funds.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No. There is no income cap, no means test, and no requirement that you be in crisis. DHHS reviews applications from adults at every income level. What matters is a clear purpose for the grant and a complete application.',
  },
  {
    question: 'Can DHHS help with medical costs?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes. DHHS reviews requests related to buying a home and keeping stable housing. This is grant assistance for a housing goal — not a bank mortgage product.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Seniors, older adults, and retirees may apply. Many DHHS awards each year go to this group, at every income level.',
  },
  {
    question: 'How much grant money does DHHS issue?',
  ...
  },
  {
    ...
    answer: `You will get a receipt from ${APPLY_FROM_NAME} (${APPLY_FROM_EMAIL}). Then a DHHS grant coordinator assigned to your file will contact you from ${COORDINATOR_EMAIL} within ${RESPONSE_HOURS} hours. Check inbox and spam. Reply on that thread.`,
  },
  {
  ...
  {
    question: 'Do I have to pay DHHS back?',
    answer:
      'No. Selected DHHS awards are grants. You do not make monthly payments to DHHS on an award. If a message asks you to “repay your grant” as if it were a loan product, pause and verify on this website first.',
  },
  {
