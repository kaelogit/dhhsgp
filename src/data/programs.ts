...
export const GRANT_PROGRAMS: GrantProgram[] = [
  {
    ...
    details:
      'DHHS grants support medical costs that insurance or savings have not fully covered — hospital stays, ongoing treatment, prescriptions, specialist visits, and recovery. Describe the care, what remains unpaid, and how a one-time grant would be used.',
  },
  {
    slug: 'housing',
    title: 'Buying a home',
  ...
  },
  {
    ...
    details:
      'Salespeople and independent workers often have the skill — and want the capital to act on it. DHHS reviews one-time grants to open, equip, or expand a business. Describe the work and what the funds would cover (equipment, a vehicle, inventory, licensing, a lease).',
  },
  {
    slug: 'education',
