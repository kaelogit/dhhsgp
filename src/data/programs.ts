...
export const GRANT_PROGRAMS: GrantProgram[] = [
  ...
  },
  {
    ...
    details:
      'For adults going back to school, finishing a credential, or covering tuition, books, tools, and related costs. DHHS grants are not student loans. If selected, you do not repay the award. Tell us the program and how completing it supports your goals.',
  },
  {
    slug: 'teachers',
    title: 'Teachers',
